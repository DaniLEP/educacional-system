...
//   // Função para ler o arquivo e importar os dados
...
//       importarNoFirebase(jsonData);
//     };

//     reader.readAsArrayBuffer(file);
//   };

//   const importarNoFirebase = async (dataArray) => {
//     const db = getDatabase(app);
...
//         const newKey = push(ref(db, "Estoque")).key;

//         updates[`Estoque/${newKey}`] = {
//           sku: item.sku || "",
//           marca: item.marca || "",
...
//     <div className="min-h-screen bg-gray-50 p-6">
//       <motion.div
//         className="max-w-6xl mx-auto bg-white rounded-2xl shadow-2xl p-6 sm:p-8 overflow-x-auto"
...
//             className="flex items-center gap-2 text-indigo-600 hover:text-indigo-400 font-semibold transition"
//           >
...
//           />
//           <select
//             className="w-full md:w-60 p-3 border rounded focus:ring-2 focus:ring-indigo-600 focus:outline-none transition"
//             value={filtroStatus}
...
//           {/* Input para importar planilha */}
//           <input
//             type="file"
//             accept=".xlsx, .xls, .csv"
//             onChange={handleFileUpload}
//             className="p-2 border rounded cursor-pointer"
//             aria-label="Importar planilha Excel/CSV"
//           />
//         </div>
...
//               }`}
//               aria-label={`Quantidade de itens com status ${key}`}
//             >
//               {key}: {value}
//             </div>
//           ))}
...
//                     <td className="p-2 border text-center whitespace-nowrap">
//                       <span
//                         className={`inline-block px-2 py-1 rounded text-xs font-semibold select-text ${
//                           item.status === "Novo"
...
//                         aria-label={`Ver detalhes do produto ${item.produto}`}
//                         className="px-3 py-1 bg-indigo-600 text-white rounded hover:bg-indigo-700 transition duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-400"
//                       >
//                         Ver Mais
//                       </button>
//                     </td>
...
//           >
//             <motion.div
//               className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto relative p-6 sm:p-8"
...
//               <h3
//                 id="modal-title"
//                 className="text-center text-indigo-700 text-3xl font-semibold mb-6 select-none"
//               >
//                 Detalhes do Produto
//               </h3>
//               <div className="flex flex-col md:flex-row gap-6">
...
//                     <strong>Status:</strong>{" "}
//                     <span
//                       className={`ml-2 inline-block px-2 py-1 rounded text-xs font-semibold select-text ${
...
//                   className="block font-medium mb-2 select-none"
//                 >
//                   Alterar Status
//                 </label>
//                 <select
...
//                 aria-label="Fechar modal motivo"
//               >
//                 <X size={20} />
//               </button>
//               <h3
//                 id="modal-motivo-title"
//                 className="text-xl text-red-700 font-bold mb-4 select-none"
//               >
...
//                 className="w-full h-28 p-3 border rounded focus:ring-2 focus:ring-red-500 resize-none focus:outline-none transition"
//                 aria-label="Texto do motivo da alteração"
//               />
//               <div className="mt-4 flex justify-end gap-3">
//                 <button
//                   onClick={fecharMotivo}
//                   className="px-5 py-2 bg-gray-300 rounded hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 transition"
//                 >
//                   Cancelar
//                 </button>
//                 <button
//                   onClick={salvarMotivo}
//                   className="px-5 py-2 bg-red-600 text-white rounded hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-600 transition"
//                 >
//                   Salvar
//                 </button>
//               </div>
